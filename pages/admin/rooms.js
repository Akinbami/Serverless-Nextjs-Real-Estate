            ...
            <div className="col-md-10">
                <div className="admin-dashboard-content">
                    <div className="d-flex justify-content-between">
                        <p className="admin-dashboard-content-header">Rooms</p>
                        <p>
                            <button type="button" onClick={toggleRoom} className="btn btn-primary btn-add-room"  data-bs-toggle="modal" data-bs-target="#exampleModal"><img src="/img/PlusCircle.png" width="20" /> <span className="px-1">Add room</span>   </button>
                                        ...
                                        <div className="modal-body">
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <select className="form-select" aria-label="Default select example" name="roomtype">
                                                    ...
                                                    <option value="1 Man">1 Man Room</option>
                                                    <option value="2 Man">2 Man Room</option>
                    ...
                    <p className="recent-transaction-header">All Rooms</p>
                    <RoomsTable rooms={rooms} token={token} />
                </div>
            </div>
        </div>
...
export async function getServerSideProps(ctx) {
    ...
    const api_res = await fetch(APPLICATION_API+`/rooms`, {
        method: 'GET',
        headers:
            { authorization: 'Bearer ' + token }
    })
