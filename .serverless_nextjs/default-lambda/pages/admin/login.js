...
/* harmony import */ var next_cookie__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(9439);
/* harmony import */ var js_cookie__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(36808);
...
function Login(props) {
  ...
  const {
    0: errorMessage,
    1: setErrorMessage
  } = (0,react__WEBPACK_IMPORTED_MODULE_6__.useState)(null); // const router = useRouter()

  console.log("pod token", js_cookie__WEBPACK_IMPORTED_MODULE_8___default().get("pod-token"));

  const handleSubmit = e => {
    e.preventDefault();
    setIsLoading(true);
    console.log("loging in ...", e.target.email.value, e.target.password.value); // setTimeout(function(){ 
    ...
    fetch("/api/login", {
      ...
      if (data.data.role == 1) {
        next_router__WEBPACK_IMPORTED_MODULE_5__.default.push("/admin/dashboard");
      } else {
        next_router__WEBPACK_IMPORTED_MODULE_5__.default.push("/dashboard");
      } // if(data.error){
  ...
  return /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_Layout__WEBPACK_IMPORTED_MODULE_4__/* .default */ .Z, {
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
      ...
      children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
        ...
        className: "col-md-6",
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
          className: "admin-login-section mx-auto px-2",
          children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("header", {
            ...
            className: "admin-login-instruction",
            children: "Enter your account login details to get access to your admin dashboard"
...
/* harmony import */ var next_dist_build_webpack_loaders_next_serverless_loader_page_handler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(99436);
      ...
      const compMod = __webpack_require__(59056)
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [7158,5087,8259,7485,9008,7424,5745,573,6255,1163,6489,9439,8034,1428,2739,422,5284], function() { return __webpack_require__(70410); })
