...
__webpack_require__.d(__webpack_exports__, {
  "default": function() { return /* binding */ tickets; },
...
const RoomsTable = props => {
  ...
  return /*#__PURE__*/_jsxs(React.Fragment, {
    children: [errorMessage ? /*#__PURE__*/_jsx("p", {
...
/* harmony default export */ var components_RoomsTable = ((/* unused pure expression or super */ null && (RoomsTable)));
// EXTERNAL MODULE: ./components/Sidbar.js
var Sidbar = __webpack_require__(85789);
;// CONCATENATED MODULE: ./components/TicketsTable.js



function TicketsTable_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

function TicketsTable_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { TicketsTable_ownKeys(Object(source), true).forEach(function (key) { TicketsTable_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { TicketsTable_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }

function TicketsTable_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
const TicketsTable_APPLICATION_API = "https://gtdo2np6f2.execute-api.us-east-1.amazonaws.com/dev";
const TicketsTable_columns = [{
  name: 'Title',
  selector: 'title',
  sortable: true,
  editable: true
  ...
  cell: row => /*#__PURE__*/jsx_runtime.jsx("p", {
    className: "mb-0",
    children: row.resolved ? /*#__PURE__*/jsx_runtime.jsx("p", {
      className: "support-ticket-completed",
      children: "Completed"
    }) : /*#__PURE__*/jsx_runtime.jsx("p", {
      className: "support-ticket-in-progress",
...
const TicketsTable_EditableCell = ({
  row,
  index,
  column,
  col,
...
const TicketsTable = props => {
  ...
  const {
    0: innerData,
    1: setInnerData
  } = (0,react.useState)(props.tickets);
  const {
    0: editingId,
    1: setEditingId
  } = (0,react.useState)('');
  ...
  const formOnChange = event => {
    const nam = event.target.name;
    const val = event.target.value;
    formData = TicketsTable_objectSpread(TicketsTable_objectSpread({}, formData), {}, {
      [nam]: val
    });
  };
  ...
  const save = item => {
    const payload = TicketsTable_objectSpread(TicketsTable_objectSpread({}, item), formData);
    ...
    if (index > -1) {
      const item = tempData[index];
      tempData.splice(index, 1, TicketsTable_objectSpread(TicketsTable_objectSpread({}, item), payload));
      setEditingId('');
      setInnerData(tempData);
      console.log("this is the temporary payload: ", payload);
      fetch(TicketsTable_APPLICATION_API + `/tickets/${payload._id}`, {
        method: 'PUT',
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
  ...
  const mergedColumns = TicketsTable_columns.map(col => {
    if (!col.editable) {
      return col;
    }

    return TicketsTable_objectSpread(TicketsTable_objectSpread({}, col), {}, {
      cell: (row, index, column) => {
        const editing = isEditing(row);
        return /*#__PURE__*/jsx_runtime.jsx(TicketsTable_EditableCell, {
          row: row,
          index: index,
          column: TicketsTable_objectSpread(TicketsTable_objectSpread({}, column), {}, {
            editing
          }),
          col: col,
          onChange: formOnChange
...
/* harmony default export */ var components_TicketsTable = (TicketsTable);
;// CONCATENATED MODULE: ./pages/admin/tickets.js
...
const tickets_APPLICATION_API = "https://gtdo2np6f2.execute-api.us-east-1.amazonaws.com/dev";
...
function Tickets(props) {
  ...
  const {
    data,
    error
  } = dist_default()(tickets_APPLICATION_API + `/admins/tickets`, fetcher);
  ...
  if (error) return /*#__PURE__*/jsx_runtime.jsx("p", {
    ...
    children: "Failed to load tickets"
  });
    ...
    children: [/*#__PURE__*/jsx_runtime.jsx(head.default, {
      ...
      children: [/*#__PURE__*/jsx_runtime.jsx("div", {
        ...
        children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
          ...
          children: [/*#__PURE__*/jsx_runtime.jsx("p", {
          ...
          }), !data || !data.data ? /*#__PURE__*/jsx_runtime.jsx("div", {
            className: "jsx-4262498705" + " " + "d-flex justify-content-center",
            children: /*#__PURE__*/jsx_runtime.jsx("div", {
              role: "status",
            ...
            children: /*#__PURE__*/jsx_runtime.jsx(components_TicketsTable, {
              tickets: data.data.docs,
              token: token
            })
          })]
        })
...
async function getServerSideProps(ctx) {
  ...
  const api_res = await fetch(tickets_APPLICATION_API + `/auth/verify-token`, {
    method: 'POST',
    headers: {
      authorization: 'Bearer ' + token,
      'Content-Type': 'application/json'
...
/* harmony default export */ var tickets = (Tickets);
...
/* harmony import */ var next_dist_build_webpack_loaders_next_serverless_loader_page_handler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(99436);
      ...
      const compMod = __webpack_require__(82396)
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [7158,5087,8259,7485,7424,1073,5855,6071,9781,6431,4479,3966,3199,5103,9651,2816,1428,2739,422,5284,5789], function() { return __webpack_require__(92340); })
