...
__webpack_require__.d(__webpack_exports__, {
  "default": function() { return /* binding */ admins; },
...
;// CONCATENATED MODULE: ./components/DeleteAdminModal.js
  ...
  const handleDelete = admin => {
    ...
    fetch(APPLICATION_API + `/admins/${admin._id}`, {
      ...
      if (data.error) {
        ...
        router.reload(window.location.pathname); // router.push("/admin/dashboard")
        // setIsLoading(false)
      }
    }).catch(error => {
      setIsLoading(false);
  ...
  return /*#__PURE__*/jsx_runtime.jsx(react.Fragment, {
    children: /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
      children: [/*#__PURE__*/jsx_runtime.jsx("button", {
        ...
        children: /*#__PURE__*/jsx_runtime.jsx(lib/* Modal */.u_, {
          isOpen: deleteModal,
          toggle: toggleDelete,
          centered: true,
            ...
            children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
              ...
              children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
                ...
                children: /*#__PURE__*/(0,jsx_runtime.jsxs)("p", {
                  className: "admin-delete-text w-75 mx-auto mt-5 mb-0 text-center",
                  children: ["Are you sure you want to remove ", /*#__PURE__*/(0,jsx_runtime.jsxs)("b", {
                    children: ["\"", admin.profile ? `${admin.profile.lastname} ${admin.profile.firstname}` : "None", "\""]
                  }), " as an admin?"]
                })
                ...
                className: "w-50 mx-auto my-5 text-center",
                children: isLoading ? /*#__PURE__*/jsx_runtime.jsx("div", {
                  class: "text-center",
                  children: /*#__PURE__*/jsx_runtime.jsx("div", {
                  ...
                  children: [/*#__PURE__*/jsx_runtime.jsx("button", {
                    type: "button",
                    className: "btn btn-primary btn-cancel-modal px-4  mx-1",
                    "data-bs-dismiss": "modal",
                    "aria-label": "Close",
                    onClick: toggleDelete,
                    children: "Cancel"
                    ...
                    type: "button",
                    className: "btn btn-outline-dark px-4 mx-1",
...
/* harmony default export */ var components_DeleteAdminModal = (DeleteAdminModal);
;// CONCATENATED MODULE: ./components/AdminsTable.js
...
const AdminsTable_APPLICATION_API = "http://127.0.0.1:5559"; // const APPLICATION_API = "https://gtdo2np6f2.execute-api.us-east-1.amazonaws.com/dev";
...
const AdminsTable = props => {
  ...
  const columns = [{
    ...
    cell: row => /*#__PURE__*/jsx_runtime.jsx("p", {
      children: row.profile ? `${row.profile.firstname} ${row.profile.lastname}` : "None"
    })
  }, {
    name: 'Role',
    selector: 'role',
    ...
    name: 'Delete Action',
    selector: '_id',
    cell: row => /*#__PURE__*/jsx_runtime.jsx(components_DeleteAdminModal, {
      admin: row,
      token: token
    })
  }];
  ...
  const save = item => {
    ...
    if (index > -1) {
      ...
      fetch(AdminsTable_APPLICATION_API + `/admins/${payload._id}`, {
        method: 'PUT',
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
...
/* harmony default export */ var components_AdminsTable = (AdminsTable);
// EXTERNAL MODULE: ./components/Sidbar.js
var Sidbar = __webpack_require__(85789);
;// CONCATENATED MODULE: ./pages/admin/admins.js
...
const admins_APPLICATION_API = "https://gtdo2np6f2.execute-api.us-east-1.amazonaws.com/dev";
...
function Admins(props) {
  ...
  const handleSubmit = e => {
    ...
    fetch(admins_APPLICATION_API + `/admins`, {
      method: 'POST',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    ...
    children: [/*#__PURE__*/jsx_runtime.jsx(head.default, {
      ...
      children: [/*#__PURE__*/jsx_runtime.jsx("div", {
        ...
        children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
                      ...
                      children: successMessage ? /*#__PURE__*/jsx_runtime.jsx("h3", {
                        ...
                        children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
                          ...
                          children: [/*#__PURE__*/jsx_runtime.jsx("label", {
                            for: "firstname",
                            className: "jsx-4262498705" + " " + "form-label login-form-label admin-form-title",
                            children: "First Name"
          ...
          }), /*#__PURE__*/jsx_runtime.jsx(components_AdminsTable, {
            admins: admins,
            token: token
          })]
        })
...
async function getServerSideProps(ctx) {
  ...
  const api_res = await fetch(admins_APPLICATION_API + `/admins`, {
    method: 'GET',
    headers: {
      authorization: 'Bearer ' + token
    }
...
/* harmony default export */ var admins = (Admins);
...
/* harmony import */ var next_dist_build_webpack_loaders_next_serverless_loader_page_handler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(99436);
      ...
      const compMod = __webpack_require__(19950)
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [7158,5087,8259,7485,7424,1073,5855,6071,9781,6431,4479,3966,5103,7185,5408,1428,2739,422,5284,5789], function() { return __webpack_require__(94063); })
